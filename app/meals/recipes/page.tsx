  ...
  return (
    <main style={{ maxWidth: 1100, margin: '0 auto', padding: '32px 20px' }}>
      ...
      <div style={{ display: 'flex', gap: 8, marginBottom: 24 }}>
        ...
        <span style={{ fontSize: 12, color: '#30a471', padding: '5px 12px', borderRadius: 6, border: '1px solid rgba(100, 240, 170,0.2)', background: 'rgba(100, 240, 170,0.06)', fontWeight: 700 }}>
