            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 12 }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexShrink: 0 }}>
                <span style={{
                  ...
                  background: s.status === 'active' ? 'rgba(127,213,170,0.15)' : 'rgba(255,255,255,0.06)',
                  color: s.status === 'active' ? '#7FD5AA' : '#A1A1A6',
                  border: `1px solid ${s.status === 'active' ? 'rgba(127,213,170,0.3)' : 'rgba(255,255,255,0.1)'}`,
                }}>
                  {s.status}
                </span>
                ...
                {confirmId === s.id ? (
                  <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                    <span style={{ fontSize: 12, color: '#ECC666' }}>Delete?</span>
                    <button
                    ...
                    >
                      {deleting === s.id ? <Spinner size={12} color="#FF9B87" strokeWidth={2} /> : null}
                      Yes, delete
                    </button>
                    <button
