  ...
  return (
    <div className="card" style={{ borderLeft: `2px solid ${isDraft ? 'rgba(236,198,102,0.4)' : 'rgba(127,213,170,0.3)'}` }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 14 }}>
        ...
        <a href="/fitness/strategy" style={{ fontSize: 11, color: isDraft ? '#ECC666' : '#7FD5AA', textDecoration: 'none', padding: '4px 10px', border: `1px solid ${isDraft ? 'rgba(236,198,102,0.2)' : 'rgba(127,213,170,0.2)'}`, borderRadius: 6, flexShrink: 0 }}>
          Full Strategy →
        </a>
      </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(150px, 1fr))', gap: 6 }}>
            {schedule.slice(0, 7).map((s, di) => (
              <div key={di} style={{ padding: '8px 10px', background: 'rgba(255,255,255,0.03)', borderRadius: 8, border: '1px solid rgba(255,255,255,0.05)' }}>
                <div style={{ fontSize: 10, fontWeight: 700, color: '#7FD5AA', marginBottom: 6 }}>{s.day?.slice(0, 3).toUpperCase()}</div>
                          ...
                          {isHovered && (
                            <button
                              ...
                              style={{
                                ...
                                background: 'rgba(255,155,135,0.15)', border: '1px solid rgba(255,155,135,0.3)',
                                color: '#FF9B87', fontSize: 9, fontWeight: 700,
