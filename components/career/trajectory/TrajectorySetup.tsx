    ...
    <div style={{ maxWidth: 600 }}>
      <div style={{ display: 'flex', gap: 8, marginBottom: 24 }}>
        {[1, 2, 3].map(s => (
          <div key={s} style={{
            ...
            background: s <= step ? '#C9B8FF' : 'rgba(255,255,255,0.1)',
          }} />
        ))}
      </div>
      ...
      {step === 1 && (
        <div className="card">
          ...
          <button
            ...
            style={{
              marginTop: 18, background: 'rgba(201,184,255,0.15)', border: '1px solid rgba(201,184,255,0.4)',
              color: '#C9B8FF', padding: '8px 20px', borderRadius: 10,
      ...
      {step === 2 && (
        <div className="card">
          ...
          {error && <p style={{ color: '#FFB4A8', fontSize: 13, marginTop: 8 }}>{error}</p>}
        </div>
      )}
          ...
          {gaps.map((gap, i) => (
            <div key={i} className="card" style={{ marginBottom: 10 }}>
              <div style={{ display: 'flex', gap: 8, alignItems: 'center', marginBottom: 6 }}>
                <span style={{
                  background: 'rgba(201,184,255,0.12)', color: '#C9B8FF',
                  border: '1px solid rgba(201,184,255,0.25)',
                  padding: '2px 8px', borderRadius: 999, fontSize: 11, fontWeight: 700,
                }}>
                  {gap.gapType}
                </span>
                <span style={{ color: gap.priority === 1 ? '#FFB4A8' : gap.priority === 2 ? '#F3D58A' : '#6E6E73', fontSize: 12, fontWeight: 600 }}>
          ...
          <div style={{ display: 'flex', gap: 10, marginTop: 16 }}>
            ...
            <button
              ...
              style={{
                ...
                color: '#9FE7C0', padding: '8px 20px', borderRadius: 10,
