      ...
      {!open ? (
        <button
          ...
          style={{
            ...
            background: 'rgba(160, 133, 255,0.08)', border: '1px dashed rgba(160, 133, 255,0.3)',
            color: '#a085ff', cursor: 'pointer',
          }}
        >
          {isMilestone ? '+ Add Progress Note' : '+ Log Progress'}
        </button>
      ) : (
        <div style={{ padding: '14px', background: 'rgba(255,255,255,0.03)', borderRadius: 10, border: '1px solid rgba(160, 133, 255,0.2)' }}>
          ...
          <div style={{ display: 'flex', gap: 8 }}>
            <button
              ...
              style={{
                ...
                background: '#a085ff', color: '#050506', border: 'none', cursor: 'pointer',
