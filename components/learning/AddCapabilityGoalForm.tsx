    ...
    return (
      <button
        ...
        style={{
          ...
          color: '#B8A4FF', padding: '9px 20px', borderRadius: 9,
  ...
  return (
    <form onSubmit={handleSubmit} style={{ display: 'grid', gap: 16 }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <p style={{ color: '#B8A4FF', fontSize: 14, fontWeight: 600 }}>New Learning Roadmap</p>
        <button
          type="button"
        ...
        <div style={{ display: 'flex', gap: 8 }}>
          <button
            ...
            style={{
              ...
              background: form.detailLevel === 'standard' ? 'rgba(184,164,255,0.12)' : 'rgba(255,255,255,0.03)',
              border: form.detailLevel === 'standard' ? '1px solid rgba(184,164,255,0.35)' : '1px solid rgba(255,255,255,0.08)',
              color: form.detailLevel === 'standard' ? '#B8A4FF' : '#6E6E73',
            }}
          >
          ...
          <button
            ...
            style={{
              flex: 1, padding: '8px 12px', borderRadius: 8, fontSize: 12, fontWeight: 600, cursor: 'pointer',
              background: form.detailLevel === 'eli5' ? 'rgba(236,198,102,0.12)' : 'rgba(255,255,255,0.03)',
              border: form.detailLevel === 'eli5' ? '1px solid rgba(236,198,102,0.35)' : '1px solid rgba(255,255,255,0.08)',
              color: form.detailLevel === 'eli5' ? '#ECC666' : '#6E6E73',
            }}
          >
      ...
      <div style={{ display: 'flex', gap: 10 }}>
        <button
          ...
          style={{
            background: saving ? 'rgba(184,164,255,0.08)' : 'rgba(184,164,255,0.15)',
            border: '1px solid rgba(184,164,255,0.4)',
            color: '#B8A4FF', padding: '9px 22px', borderRadius: 9,
