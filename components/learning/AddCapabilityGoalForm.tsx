    ...
    return (
      <button
        ...
        style={{
          ...
          color: '#a085ff', padding: '9px 20px', borderRadius: 9,
  ...
  return (
    <form onSubmit={handleSubmit} style={{ display: 'grid', gap: 16 }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <p style={{ color: '#a085ff', fontSize: 14, fontWeight: 600 }}>New Learning Roadmap</p>
        <button
          type="button"
          ...
          {roadmapTypes.map(t => (
            <button
              ...
              style={{
                ...
                background: form.roadmapType === t.value ? 'rgba(160, 133, 255,0.15)' : 'rgba(255,255,255,0.04)',
                border: form.roadmapType === t.value ? '1px solid rgba(160, 133, 255,0.4)' : '1px solid rgba(255,255,255,0.08)',
                color: form.roadmapType === t.value ? '#a085ff' : '#6E6E73',
        ...
        <div style={{ display: 'flex', gap: 8 }}>
          <button
            ...
            style={{
              ...
              background: form.detailLevel === 'standard' ? 'rgba(160, 133, 255,0.12)' : 'rgba(255,255,255,0.03)',
              border: form.detailLevel === 'standard' ? '1px solid rgba(160, 133, 255,0.35)' : '1px solid rgba(255,255,255,0.08)',
              color: form.detailLevel === 'standard' ? '#a085ff' : '#6E6E73',
            }}
          >
          ...
          <button
            ...
            style={{
              flex: 1, padding: '8px 12px', borderRadius: 8, fontSize: 12, fontWeight: 600, cursor: 'pointer',
              background: form.detailLevel === 'eli5' ? 'rgba(255, 206, 83,0.12)' : 'rgba(255,255,255,0.03)',
              border: form.detailLevel === 'eli5' ? '1px solid rgba(255, 206, 83,0.35)' : '1px solid rgba(255,255,255,0.08)',
              color: form.detailLevel === 'eli5' ? '#ffce53' : '#6E6E73',
            }}
          >
      ...
      <div style={{ display: 'flex', gap: 10 }}>
        <button
          ...
          style={{
            background: saving ? 'rgba(160, 133, 255,0.08)' : 'rgba(160, 133, 255,0.15)',
            border: '1px solid rgba(160, 133, 255,0.4)',
            color: '#a085ff', padding: '9px 22px', borderRadius: 9,
