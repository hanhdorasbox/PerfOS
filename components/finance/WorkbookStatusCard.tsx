    ...
    return (
      <div className="card" style={{ display: 'flex', flexDirection: 'column', gap: 12, padding: '20px 24px' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 16 }}>
          <div>
            <p style={{ color: '#FFB4A8', fontSize: 13, fontWeight: 600 }}>No workbook connected</p>
          ...
          <div style={{ display: 'flex', gap: 8, flexShrink: 0 }}>
            ...
            <button
              ...
              style={{
                ...
                color: '#C9B8FF', padding: '10px 22px', borderRadius: 8,
            ...
            >
              ...
              {uploading && (
                <div style={{ width: '100%', height: 3, background: 'rgba(201,184,255,0.2)', borderRadius: 2, overflow: 'hidden' }}>
                  {uploadPct >= 98 ? (
                    /* Pulsing stripe during finalization so it doesn't look frozen */
                    <div style={{
                      height: '100%', borderRadius: 2,
                      background: 'linear-gradient(90deg, rgba(201,184,255,0.4) 0%, rgba(201,184,255,0.9) 50%, rgba(201,184,255,0.4) 100%)',
                    ...
                    <div style={{
                      height: '100%', borderRadius: 2,
                      background: 'rgba(201,184,255,0.8)',
                      width: `${uploadPct}%`,
        ...
        {uploadErr && (
          <div style={{
            ...
            color: '#FFB4A8', padding: '8px 12px', borderRadius: 6, fontSize: 12, marginTop: 4,
          }}>
            {uploadErr}
          </div>
        )}
  ...
  return (
    <div className="card" style={{ padding: '20px 24px' }}>
            ...
            {uploading && (
              <div style={{ width: '100%', height: 2, background: 'rgba(255,255,255,0.08)', borderRadius: 1, overflow: 'hidden' }}>
                <div style={{
                  ...
                  background: 'rgba(201,184,255,0.6)',
                  width: `${uploadPct}%`,
      ...
      {uploadErr && (
        <div style={{
          background: 'rgba(255,180,168,0.1)', border: '1px solid rgba(255,180,168,0.3)',
          color: '#FFB4A8', padding: '8px 12px', borderRadius: 6, fontSize: 12, marginTop: 12,
        }}>
          {uploadErr}
        </div>
      )}
