    ...
    <div className="card">
      ...
      {!aiAnalysis && (
        <div style={{ background: 'rgba(180,167,229,0.07)', border: '1px solid rgba(180,167,229,0.2)', borderRadius: 12, padding: '16px 20px', marginBottom: 16 }}>
          <p style={{ color: '#B8B6B0', fontSize: 13, marginBottom: 14 }}>No AI analysis yet.</p>
          {regenError && <p style={{ color: '#FF6B6B', fontSize: 12, marginBottom: 10 }}>{regenError}</p>}
          <button
            onClick={regenerate}
            disabled={regenerating}
            style={{
              ...
              color: '#B4A7E5', padding: '8px 18px', borderRadius: 8, fontSize: 13, fontWeight: 600,
              cursor: regenerating ? 'not-allowed' : 'pointer',
            }}
          >
        ...
        <>
          ...
          <div style={{ marginTop: 14, display: 'flex', justifyContent: 'flex-end' }}>
            <button
              onClick={regenerate}
              disabled={regenerating}
              style={{ background: 'none', border: '1px solid rgba(255,255,255,0.1)', color: '#76746E', borderRadius: 6, padding: '4px 12px', fontSize: 11, cursor: regenerating ? 'not-allowed' : 'pointer' }}
            >
